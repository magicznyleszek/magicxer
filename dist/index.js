...
Object.defineProperty(exports, "__esModule", { value: true });
var mixer_1 = __webpack_require__(2);
exports.magicxer = mixer_1.mixer;
...
Object.defineProperty(exports, "__esModule", { value: true });
var syllabler_1 = __webpack_require__(3);
var writing_1 = __webpack_require__(0);
var Mixer = /** @class */ (function () {
    ...
    Mixer.prototype.mixBySyllablesJoin = function (stWord, ndWord) {
        var mixes = [];
        var stSyllables = syllabler_1.syllabler.split(stWord);
        var ndSyllables = syllabler_1.syllabler.split(ndWord);
        ...
        for (var stIndex = 0; stIndex < stWord.length; stIndex++) {
            ...
            for (var ndIndex = 0; ndIndex < ndWord.length; ndIndex++) {
                ...
                if (stLetter === ndLetter ||
                    (writing_1.writing.isVowel(stLetter) && writing_1.writing.isVowel(ndLetter))) {
    ...
    Mixer.prototype.mixByCoolPairs = function (stWord, ndWord) {
        ...
        for (var stIndex = 0; stIndex < stWord.length; stIndex++) {
            ...
            for (var ndIndex = 0; ndIndex < ndWord.length; ndIndex++) {
                var ndLetter = ndWord[ndIndex];
                if (writing_1.writing.isSingleSoundPair(stWord[stIndex], ndWord[ndIndex])) {
...
var Syllabler = /** @class */ (function () {
    ...
    Syllabler.prototype.splitPrefix = function (chunks) {
        ...
        for (var _i = 0, _a = writing_1.writing.getPrefixes(); _i < _a.length; _i++) {
            var prefix = _a[_i];
    ...
    Syllabler.prototype.splitGeneralSuffix = function (chunks) {
        ...
        if (workWord) {
            for (var _i = 0, _a = writing_1.writing.getSuffixes(); _i < _a.length; _i++) {
                var suffix = _a[_i];
    ...
    Syllabler.prototype.splitCkleLeSuffix = function (chunks) {
        ...
        if (workWord && workWord.slice(workWord.length - "le".length) === "le") {
            ...
            if (workWord.slice(workWord.length - "ckle".length) === "ckle") {
                ...
                writing_1.writing.isConsonant(workWord[workWord.length - 3])) {
                lettersToCut = 3;
            }
            if (lettersToCut) {
                chunks.pop();
    ...
    Syllabler.prototype.splitByMultipleConsonantsInRow = function (chunks) {
        chunks.forEach(function (chunk, index) {
            ...
            if (writing_1.writing.isPrefix(chunk) || writing_1.writing.isSuffix(chunk)) {
                return;
            }
            ...
            for (var i = chunk.length - 1; i >= 0; i--) {
                var letter = chunk[i];
                if (writing_1.writing.isConsonant(letter)) {
                    consonantsInRow++;
                }
                lettersSinceSplit++;
                if (consonantsInRow >= 2 && (writing_1.writing.isVowel(letter) || i === 0)) {
                    // we should split between 1st and 2nd consonant in whole group,
                    // but if current letter is a vowel, we need to move the split
                    var splitIndex = i + 1;
                    if (writing_1.writing.isVowel(letter)) {
                        splitIndex += 1;
                    }
                    // split current chunk
                    ...
                    if (writing_1.writing.isValidSyllable(left) &&
                        writing_1.writing.isValidSyllable(right) &&
                        !writing_1.writing.isSingleSoundPair(left[left.length - 1], right[0])) {
    ...
    Syllabler.prototype.splitBySurroundedConsonants = function (chunks) {
        chunks.forEach(function (chunk, index) {
            ...
            for (var i = chunk.length - 1; i >= 0; i--) {
                ...
                i !== 0 &&
                    i !== chunk.length - 1 &&
                    writing_1.writing.isConsonant(letter) &&
                    writing_1.writing.isVowel(chunk[i - 1]) &&
                    writing_1.writing.isVowel(chunk[i + 1])) {
                    // split current chunk
...
exports.syllabler = new Syllabler();
